...
export default async function MarketingApplicationsPage({
  ...
  await requireRole(["SUPER_ADMIN", "CAMPUS_ADMIN", "MARKETING_OFFICER"]);
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ApplicationsQueue basePath="/marketing/applications" activeStatus={activeStatus} applications={applications} />
    </div>
  );
}
