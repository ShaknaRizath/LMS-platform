  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground">Review semester registrations and payments.</p>
      </div>
            ...
            <TableBody>
              {registrations.map((registration) => (
                <TableRow key={registration.id}>
                  <TableCell>
                    <Link href={`/admin/registrations/${registration.id}`} className="font-medium hover:underline">
