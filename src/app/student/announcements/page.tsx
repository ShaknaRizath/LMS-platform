      ...
      {announcements.length === 0 ? (
        <Empty>
          <EmptyHeader>
            ...
            <EmptyDescription>Notices from your modules and the campus will appear here.</EmptyDescription>
          </EmptyHeader>
        </Empty>
      ) : (
          ...
          {announcements.map((announcement) => (
            <Card key={announcement.id}>
              <CardHeader>
                ...
                <CardDescription>
                  {announcement.module ? (
                    <Link href={`/student/modules/${announcement.moduleId}`} className="hover:underline">
